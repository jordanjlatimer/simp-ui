...
export const Input = ({ initialValue, changeValidation = value => true, onChange = value => value, valueValidation = value => {
    return { invalid: false, message: "" };
}, label, valueDisplay = value => value, password = false, placeholder, prefix, suffix, width = "medium", }) => {
    ...
    return (React.createElement("div", { className: "input" },
        ...
        React.createElement("div", { className: "input-container" },
            React.createElement("input", { className: "input-control" + (invalid ? " invalid" : "") + " " + width, onBlur: blurFunc, value: valueDisplay(value), onFocus: focusFunc, type: password ? "password" : "text", placeholder: placeholder, ref: control, onChange: changeFunc }),
