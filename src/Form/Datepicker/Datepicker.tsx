      ...
      if (i === 0){
        ...
        if (weekDays !== 6){
          for (let j = 0; j <= weekDays; j++){
            returnArray.push(<div key={j} className="datepicker-picker-days-day"/>)
          }
        }
      }
      else{
      ...
      <div>
        ...
        >
          <div className="datepicker-picker-navbar">
            <FaAngleDoubleLeft
              onClick = {() => {setDay(0); setYear(year - 1);}}
            />
            <FaAngleLeft
              onClick = {() => month === 0 ? (setDay(0), setMonth(11), setYear(year - 1)) : (setDay(0), setMonth(month - 1))}
            />
            <div>
              {
                day > 0 ? 
            ...
            <FaAngleRight
              onClick = {() => month === 11 ? (setDay(0), setMonth(0), setYear(year + 1)) : (setDay(0), setMonth(month + 1))}
            />
            <FaAngleDoubleRight
              onClick = {() => {setDay(0); setYear(year - 1);}}
            />
          ...
          <div className="datepicker-picker-days">
            {
              [
                ...
                return (
                  <div 
                    key={label} 
                    className="datepicker-picker-days-header"
                  >
                    {label}
                  </div>
                )
