...
export const YAxis = React.forwardRef<SVGSVGElement, YAxisProps>(
  ({ yTicks, width, height, maxY, minY, prefix, suffix, title, tickColor, tickWidth, titleHeight }, ref) => {
