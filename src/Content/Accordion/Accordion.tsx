...
function Accordion({ label, items, multiple = false }: AccordionProps){
  ...
  return(
    <div className="accordion">
      ...
      <div className="accordion-contents">
        {items.map((item, i) => {
          return <div className="accordian-item" key={item.label}>
            <div 
              className={"accordion-item-label" + (i === 0 ? " first" : "") + (i === items.length - 1 ? " last" : "")}
              onClick={() => {
                multiple ? 
                  expanded.includes(i) ? 
            ...
            <div className={"accordion-item-box" + (expanded.includes(i) ? " open" : "")}>
